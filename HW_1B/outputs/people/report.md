...
**Видео:** `data/videos/people-detection.mp4`  
...
### LK (Sparse)
- стартовых точек: **80**
- активных точек в конце: **253**
- mean retention: **1.013**, p10 retention: **0.982**
- mean FB-error: **0.076 px**, p95 FB-error: **0.355 px**
- mean длина трека: **42.4 кадров**, p10 длины: **2.5**
...
### Farnebäck (Dense)
- mean motion ratio: **0.0422**, p95: **0.0795**
- mean #components: **0.50**, p95: **1.00**
- mean largest-comp ratio: **0.39**, p10: **0.00**
- mean |∇mag|: **0.2533** (прокси шума)
...
- **LK часто теряет точки**: много коротких треков (p10 длины < 10 кадров). Причины: blur / мало текстуры / окклюзии.
